...
class EarlyLeaves extends StatefulWidget {
   EarlyLeaves({Key? key}) : super(key: key);
  @override
  State<EarlyLeaves> createState() => _EarlyLeavesState();

}

class _EarlyLeavesState extends State<EarlyLeaves> {
                        ...
                        Column(
                            children:[
                              ...
                              Container(
                                ...
                                width: 130.w,
                                child: Text("Early Leavers",style: GoogleFonts.poppins(fontSize:12.sp,
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        child: Padding(
                                          padding: EdgeInsets.symmetric( horizontal: 12.5.sp,vertical: 3.5.sp),
                                          child: Row(
                                            children: [
              ...
              children: [
                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: Text("Total Early Comers: 3",style: GoogleFonts.poppins(fontSize:12.sp,
                        ...
                        child: Row(
                          children: [
                            ...
                            Text(TextStrings.Timein,style: GoogleFonts.poppins(fontSize:12.sp,
                                color: blackClr,fontWeight: FontWeight.w600),),
                            Spacer(),
                            Text(TextStrings.Earlyby,style: GoogleFonts.poppins(fontSize:12.sp,
                                color: blackClr,fontWeight: FontWeight.w600),),
                            SizedBox(width: 9.w,),
                          ],
                        ),
          ...
          Container(
            ...
            child:  Row(
              children: [
                ...
                SizedBox(width: 5.w,),
                Text("Hammmad",style: GoogleFonts.poppins(fontSize:10.sp,
